...
Vehicle.create!(name: "BRDM-2", miles_per_gallon: 6, fuel_on_vehicle: 77, user_id: 1, trip_id: 1)
Vehicle.create!(name: "GAZ Tigr-7", miles_per_gallon: 15, fuel_on_vehicle: 10, user_id: 1, trip_id: 1)
...
Vehicle.create!(name: "IFV LAV-25", miles_per_gallon: 9, fuel_on_vehicle: 48, user_id: 2, trip_id: 2)
Vehicle.create!(name: "Ural-375", miles_per_gallon: 3, fuel_on_vehicle: 30, user_id: 2, trip_id: 2)
Vehicle.create!(name: "FAW semi-trailer truck", miles_per_gallon: 7, fuel_on_vehicle: 142, user_id: 2, trip_id: 2)

# This trip has the first two legs of trip #2, but it has an additional 2 legs.)
Leg.create!(description: "HWY N5 High Desert Run (West of Al-Abr)", distance: 110, altitude_change: 830, terrain: "paved_road", user_id: 2) # leg 5
...
Vehicle.create!(name: "GAZ Tigr-21", miles_per_gallon: 15, fuel_on_vehicle: 14, user_id: 1, trip_id: 3)
Vehicle.create!(name: "Mercedes-Benz Arocs", miles_per_gallon: 9, fuel_on_vehicle: 127, user_id: 2, trip_id: 3)
Vehicle.create!(name: "Bushmaster PMV", miles_per_gallon: 13, fuel_on_vehicle: 29, user_id: 2, trip_id: 3)
...
Leg.create!(description: "HWY N5 Eastbound to E5", distance: 132, altitude_change: 3720, terrain: "dirt_road", user_id: 2) # leg 8

Trip.create!(name: "Marib to Through Hadhramaut", start_location: "Marib", finish_location: "Fugmah", total_fuel_actually_consumed: nil) # trip 4
...
Vehicle.create!(name: "LAV-16", miles_per_gallon: 16, fuel_on_vehicle: 37, user_id: 3, trip_id: 4)
Vehicle.create!(name: "Mercedes-Benz Axor", miles_per_gallon: 8, fuel_on_vehicle: 30, user_id: 2, trip_id: 4)
Vehicle.create!(name: "Mercedes-Benz Atego", miles_per_gallon: 7, fuel_on_vehicle: 76, user_id: 3, trip_id: 4)
